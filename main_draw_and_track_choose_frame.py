...
from utils.general import is_video_file, is_video_stream, Dirs, setup_video_writer, skip_frames
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', default='videos/thermal.mp4',
    ...
    # Skip some frames before drawing boxes
    skip_frames(cam)
