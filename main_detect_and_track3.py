import argparse
import torch
from detect_and_track.yolov5_x_tracker import detect_and_track3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/videos/sample.avi', help='source')  # file/folder, 0 for webcam
